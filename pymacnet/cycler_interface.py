...
class CyclerInterface():
    ...
    def read_channel_status(self, channel: int) -> dict:
        ...
        # Subtract by 1 to account for Maccor zero indexing of channel
        __channel = channel-1

        #msg_outgoing_dict = copy.deepcopy(pymacnet.messages.tx_read_status_msg)
        msg_outgoing_dict = pymacnet.messages.tx_read_status_msg
        msg_outgoing_dict['params']['Chan'] = __channel
